...
class MyEdit extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const FamiliarEdit(title: 'Edit Profile'),
    );
  }
}

class FamiliarEdit extends StatefulWidget {
  const FamiliarEdit({super.key, required this.title});

  final String title;

  @override
  State<FamiliarEdit> createState() => _FamiliarEditState();
}

class _FamiliarEditState extends State<FamiliarEdit> {
  ...
  void _get_data() async{
    ...
    final urls = Uri.parse('$url/myapp/Blind_update/');
    try {
  ...
  void _send_data() async{
    ...
    final urls = Uri.parse('$url/myapp/Edit_blind/');
    try {
